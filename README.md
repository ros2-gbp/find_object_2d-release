## find_object_2d (rolling) - 0.7.4-1

The packages in the `find_object_2d` repository were released into the `rolling` distro by running `/usr/bin/bloom-release find_object_2d --ros-distro rolling` on `Sun, 01 Jun 2025 22:08:23 -0000`
...
## find_object_2d (rolling) - 0.7.3-2

The packages in the `find_object_2d` repository were released into the `rolling` distro by running `/usr/bin/bloom-release find_object_2d --ros-distro rolling` on `Wed, 28 May 2025 04:06:21 -0000`
...
## find_object_2d (rolling) - 0.7.3-1

The packages in the `find_object_2d` repository were released into the `rolling` distro by running `/usr/bin/bloom-release find_object_2d --ros-distro rolling` on `Wed, 28 May 2025 04:00:43 -0000`
...
## find_object_2d (kilted) - 0.7.2-1

The packages in the `find_object_2d` repository were released into the `kilted` distro by running `/usr/bin/bloom-release find_object_2d --ros-distro kilted --edit` on `Mon, 26 May 2025 22:55:00 -0000`
...
## find_object_2d (rolling) - 0.7.2-1

The packages in the `find_object_2d` repository were released into the `rolling` distro by running `/usr/bin/bloom-release find_object_2d --ros-distro rolling` on `Mon, 26 May 2025 22:51:04 -0000`
...
## find_object_2d (rolling) - 0.7.1-1

The packages in the `find_object_2d` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling --edit-track find_object_2d` on `Thu, 27 Jun 2024 15:35:40 -0000`
...
## find_object_2d (jazzy) - 0.7.1-2

The packages in the `find_object_2d` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --ros-distro jazzy --edit-track find_object_2d` on `Thu, 27 Jun 2024 15:28:51 -0000`
...
## find_object_2d (jazzy) - 0.7.1-1

The packages in the `find_object_2d` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --ros-distro jazzy --edit-track find_object_2d` on `Thu, 27 Jun 2024 15:22:24 -0000`
